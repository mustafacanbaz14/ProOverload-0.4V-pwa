...
const Navbar = memo(({ view, setView }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 max-w-[420px] mx-auto bg-zinc-950/90 backdrop-blur-xl border-t border-zinc-800/80 h-16 flex items-center justify-around z-30 pb-safe shadow-2xl">
      {navItems.map((item) => {
